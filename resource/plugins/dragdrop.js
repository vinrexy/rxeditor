...
(function (rxeditor) {
	...
	rxeditor.plugins.dragdrop = function () {
		if (!isSupported) {
			return;
		}
		...
		function createHolder(toReplace) {
			...
			placeholder.className = 'rxeditor-ignore';
		...
		base.signalReady = function () {
			...
			cover = container.appendChild(rxeditor.dom.parseHTML(
				'<div class="rxeditor-dnd-cover" style="display: none">' +
