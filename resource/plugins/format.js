/**
 * RXEditor Paragraph Formatting Plugin
 ...
 *
 * @fileoverview RXEditor Paragraph Formatting Plugin
 * @author Vinrexy
 */
(function (rxeditor) {
	'use strict';

	rxeditor.plugins.format = function () {
		var base = this;
		...
		base.init = function () {
			...
			if (opts.toolbar === rxeditor.defaultOptions.toolbar) {
		...
		formatCmd = function (caller) {
			...
			rxeditor.utils.each(tags, function (tag, val) {
				var link = document.createElement('a');
				link.className = 'rxeditor-option';
