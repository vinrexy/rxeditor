/**
 * RXEditor SVG material icons plugin
...
(function (document, rxeditor) {
	...
	rxeditor.icons.material = function () {
		var nodes = {};
		...
		return {
			create: function (command) {
				if (command in icons) {
					...
					nodes[command] = rxeditor.dom.parseHTML(
	...
	rxeditor.icons.material.icons = icons;
})(document, rxeditor);
